  ...
  return (
    <div className="mt-24">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounder-2xl md:w-780">
            ...
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                  <p>
                    <span className="text-3xl font-semibold">$88,239</span>
                    <span 
                ...
                <div className="mt-8">
                  <p>
                    <span className="text-3xl font-semibold">$55,861</span>
